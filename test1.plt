...
set xdata time
set timefmt cb "%d.%m.%Y %H:%M:%S"
set timefmt y2 "%d.%m.%Y %H:%M:%S"
set y2data 
...
set xrange [ "20.03.2015 13:50:14" : "20.03.2015 14:44:53" ] noreverse nowriteback
...
GNUTERM = "windows"
col = 10
plot for [col=1:10] 'D:\svn\git\memuse_convert\memusage.log.txt.csv' using 1:col with lines title columnheader
#    EOF
